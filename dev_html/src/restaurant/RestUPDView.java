...
public class RestUPDView extends JDialog implements ActionListener{
	...
	JTextArea 	jtf_info 	= new JTextArea(8,25);
	JScrollPane jsp_info 	= new JScrollPane(jtf_info);
	...
	public RestUPDView(Map<String,Object> pMap) {
		initDisplay();
		
		 jtf_name.setText(pMap.get("res_num").toString());
		 jtf_addr.setText(pMap.get("res_addr").toString());
		 jtf_info.setText(pMap.get("res_info").toString());
		 jtf_lat.setText(pMap.get("lat").toString());
		 jtf_lng.setText(pMap.get("lng").toString());
		 jtf_photo.setText(pMap.get("res_photo").toString());
		 jtf_tel.setText(pMap.get("res_tel").toString());
		 jtf_time.setText(pMap.get("res_time").toString());
	}
	/*
	 * dvi#d_msg{postion: absolute;}
	 */
	public void initDisplay() {
		...
		jbtn_save.setBounds(110, 310, 100, 20);
		jbtn_close.setBounds(240, 310, 100, 20);
